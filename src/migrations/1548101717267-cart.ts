...
export class cart1548101717267 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `cart_item` (`id` int NOT NULL AUTO_INCREMENT, `quantity` int NOT NULL, `title` varchar(255) NOT NULL, `price` varchar(255) NOT NULL, `created` datetime NOT NULL, `userId` int NULL, `productId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
